...
public class GraphicalInterface : MonoBehaviour
{
    ...
    {
        // Timer
        timerPanelText.text = Time.realtimeSinceStartup.ToString("0.00");
        // FPS
        FPSCount += 1;
    ...
    public void SetRobot(GameObject robot, bool isNewRobot)
    {
        ...
        minimapCamera.cullingMask = LayerMask.GetMask("Robot", "Map", "ARObject");
        // minimap framerate
        ...
        mapCamera.cullingMask = LayerMask.GetMask("Robot", "Map", "ARObject");
