...
public class AmclSubscriber : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (isMessageReceived)
        {
            ...
            //unity_position.x = 1.07f*unity_position.x + 13.2f ;    //through linear regression
            ...
            // unity_position.z = (float)(+ 1.6*unity_position.z); //this works
            unity_position.z = (float)(+ 1.8*unity_position.z); //this works
